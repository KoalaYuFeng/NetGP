...
//     xrt::kernel krnl_read[kernel_size+1];
//     xrt::kernel krnl_write[kernel_size+1];
...
//     krnl_name_full = "vertexApply:{vertexApply_1}";
...
//     run_merge_0.set_arg(3, DATA_SIZE);
//     auto run_merge_1 = xrt::run(krnl_merge[1]);
//     run_merge_1.set_arg(3, DATA_SIZE);

//     auto run_forward_0 = xrt::run(krnl_forward[0]);
//     run_forward_0.set_arg(3, DATA_SIZE);
//     auto run_forward_1 = xrt::run(krnl_forward[1]);
//     run_forward_1.set_arg(3, DATA_SIZE);
