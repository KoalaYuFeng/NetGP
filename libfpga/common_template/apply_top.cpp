...
#pragma HLS stream variable=vertexPropStream depth=128
        ...
        static hls::stream<burst_raw>      tmpVertexPropArray[SUB_PARTITION_NUM];
#pragma HLS stream variable=tmpVertexPropArray depth=2


        static hls::stream<burst_raw>      tmpVertexPropStream[SUB_PARTITION_NUM + 1];
...
#pragma HLS stream variable=newVertexPropArray depth=2
        ...
        dummyStream(vertexNum, tmpVertexPropStream[0]);
