...
extern "C" {
    void  writeVertex(
        ...
        hls::stream<burst_raw>  &output_to_net,
        unsigned int            vertexNum
    )
    {
#pragma HLS INTERFACE m_axi port=output_to_mem offset=slave bundle=gmem%THUNDERGP_GMEM_ID% max_read_burst_length=64 num_write_outstanding=4
